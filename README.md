...
Nothing public tests the pattern  actually used: a shared framework distributed as
...
| **3** | Run `./pack-to-local-feed.sh`, switch `DemoService` to `PackageReference` | . Does anything still see Newtonsoft? Is reachability still possible? |
